  ...
  return (
    <div className="md:relative">
      ...
      >
        ...
        <Icon name={props.toggleIcon} width={21} height={21} color="#000000" />
      </button>
      ...
      <motion.div
        ...
        className="left-4 right-4 sm:left-7 sm:right-7 absolute md:right-0 md:left-[unset] md:w-[400px] z-20 mt-2 rounded-[4px] bg-white overflow-hidden"
        initial="hide"
        ref={ref}
      ...
      >
        <div className="flex items-center justify-between px-4 py-[14px] border-b border-b-[#3b4253]">
          <h4 className="text-lg font-medium text-black">{props.menuTitle}</h4>
        ...
        <ul className="w-full text-black">
          {props.dataList.map((item: any, index: number) => (
            ...
            >
              ...
              <div>
                <p className="text-sm ml-[7px] select-none text-black font-medium">
                  {item.title}
                </p>
                <small className="text-xs ml-[7px] select-none text-black">
                  {item.text}
                </small>
              </div>
            </li>
        ...
        <div className="flex items-center justify-between px-4 py-[14px]">
          <button
            className="px-5 py-[9px] w-full bg-[#7367f0] text-black font-medium text-sm rounded-md hover:shadow-indigo transition-shadow duration-300"
            onClick={handleClose}
          >
            {props.buttonText}
          </button>
