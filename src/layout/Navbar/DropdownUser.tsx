...
const DropdownUser = () => {
  ...
  return (
    <div className="md:relative">
      ...
      >
        <div className="flex items-center justify-start cursor-pointer pr-3">
          <div className="mr-2 flex flex-col items-end justify-center">
            <p className="text-black font-semibold tracking-wider text-[14px]">
              Mugesh Rao
            </p>
            <span className="text-[11px] text-black leading-3">admin</span>
          </div>
          <img src="/images/user.png" className="w-10" alt="Mugesh Rao" />
        </div>
      </button>
      ...
      >
        <ul className="w-full text-black p-2">
