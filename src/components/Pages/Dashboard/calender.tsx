...
const Calender = () => {
  return (
    <div className='flex items-center justify-center relative bg-white p-[20px] rounded-md '>
    <div className='w-full max-w-lg p-6 mx-auto bg-[#283046] rounded-2xl shadow-xl flex flex-col'>
